...
# Previous Projects
  - <img src="sMon.png" alt="Thumbnail Image" style="max-width: 20%; max-height: 20%;"> Visualisation tool to predicts the probability of the species in different parts of Germany.
